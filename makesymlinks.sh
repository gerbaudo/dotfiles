...
files="bashrc bash_aliases bash_profile bash_profile_gpatlas bash_prompt emacs screenrc sshconfig keydoublerc"    # list of files/folders to symlink in homedir
